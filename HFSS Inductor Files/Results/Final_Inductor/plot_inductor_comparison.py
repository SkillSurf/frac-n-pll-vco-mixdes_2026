...
colors = {
    'q_nominal': '#1f77b4',      # Blue
    'q_increased': '#7570b3',    # Purple
    'q_reduced': '#d95f02',      # Dark Orange
    'l_nominal': '#e31a1c',      # Red
    'l_increased': '#ff7f00',    # Orange
    'l_reduced': '#33a02c'       # Green
}
...
# Create single annotation box for Q values at the three frequencies
...
ax1.text(0.02, 0.98, q_text.strip(),
         ...
         bbox=dict(boxstyle='round,pad=0.7', facecolor='lightblue', 
                  edgecolor=colors['q_nominal'], alpha=0.95, linewidth=2.5),
         zorder=11)

# Create single annotation box for L values at the three frequencies
l_text = "Inductance (L):\n"
...
ax2.text(0.98, 0.02, l_text.strip(),
         ...
         bbox=dict(boxstyle='round,pad=0.7', facecolor='#ffe6e6', 
                  edgecolor=colors['l_nominal'], alpha=0.95, linewidth=2.5),
         zorder=11)
...
plt.savefig('inductor_comparison_plot.png', dpi=300, bbox_inches='tight')
plt.savefig('inductor_comparison_plot.pdf', bbox_inches='tight')

print("Plot saved as 'inductor_comparison_plot.png' and 'inductor_comparison_plot.pdf'")
