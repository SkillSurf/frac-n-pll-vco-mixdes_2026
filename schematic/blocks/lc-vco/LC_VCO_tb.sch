...
N 650 -450 700 -450 {lab=OUTp}
N 650 -430 700 -430 {lab=VCTRL}
N 400 -450 440 -450 {lab=VCTRL}
N 540 -350 540 -320 {lab=GND}
N 80 -510 80 -490 {lab=Ibias}
N 400 -430 440 -430 {lab=Ibias}
N 540 -550 540 -530 {lab=VDD}
C {vsource.sym} 140 -460 0 0 {name=V1 value=1.2 savecurrent=false}
C {vsource.sym} 200 -460 0 0 {name=V2 value=0.8 savecurrent=false}
...
C {lab_pin.sym} 400 -450 0 0 {name=p3 sig_type=std_logic lab=VCTRL}
C {lab_pin.sym} 400 -430 0 0 {name=p7 sig_type=std_logic lab=Ibias}
C {devices/vdd.sym} 540 -550 0 0 {name=l7 lab=VDD}
C {lab_pin.sym} 700 -450 0 1 {name=p1 sig_type=std_logic lab=OUTp}
C {lab_pin.sym} 700 -430 0 1 {name=p2 sig_type=std_logic lab=OUTn}
